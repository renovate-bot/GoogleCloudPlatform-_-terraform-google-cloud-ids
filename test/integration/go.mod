module github.com/terraform-google-modules/cloud-ids/test/integration

go 1.23.0

toolchain go1.24.11

require github.com/GoogleCloudPlatform/cloud-foundation-toolkit/infra/blueprint-test v0.17.9
